...
const firstName = "Siza"
const lastName = "Mpafa"
let age = 0
const fullName = firstName + " " + lastName
const greeting = `Greetings to you ${fullName} who's aged ${age}` 
console.log(greeting);
age = 28
const greetings = `Greetings to you ${fullName} who's aged ${age}` 
